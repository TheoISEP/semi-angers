# Semi-marathon d'Angers - Site Vitrine

[![Next.js](https://img.shields.io/badge/Next.js-16.2.6-black?logo=next.js)](https://nextjs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.x-blue?logo=typescript)](https://www.typescriptlang.org/)

Site web officiel de la première édition du Semi-marathon d'Angers (2027).

## 📋 Vue d'ensemble

Landing page moderne et responsive pour promouvoir la première édition du Semi-marathon d'Angers, une course à pied exceptionnelle dans la ville d'Angers.

### Objectifs du site
- ✨ Teaser l'événement de 2027
...
- **parcours.jpg** : Photo de la ville d'Angers
- **ambiance.jpg** : Photo d'ambiance avec des coureurs
- **access.jpg** : Photo d'arrivée ou du parcours
- **runners.png** : Photo de coureurs de tous niveaux
...
Développé avec ❤️ pour le Semi-marathon d'Angers • 2027
