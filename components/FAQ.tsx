...
const faqs = [
  {
    question: "Qui peut participer au Semi-marathon d'Angers ?",
  ...
  {
    question: "Comment accéder au départ ?",
    answer: "Le départ est situé dans le centre-ville d'Angers, facilement accessible en transport. Des informations détaillées sur l'accès seront communiquées avec votre dossard.",
  },
  {
