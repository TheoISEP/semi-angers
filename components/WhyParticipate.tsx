...
const reasons = [
  {
    ...
    description: "Parcours exceptionnel dans la ville d'Angers, traversant les plus beaux quartiers de la ville. Un tracé rapide, idéal pour viser un record personnel.",
    icon: "running",
    image: "/images/parcours.jpg",
  },
  {
    title: "Une ambiance unique",
    description: "Profitez d'un événement convivial dans un cadre urbain exceptionnel. Des milliers de coureurs partageront cette aventure avec vous.",
    icon: "celebration",
    image: "/images/ambiance.jpg",
  },
  {
    title: "Au cœur d'Angers",
    description: "Découvrez la ville d'Angers sous un nouvel angle, rejoignez facilement le départ et partagez ce moment avec vos proches.",
    icon: "train",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto px-2 font-medium">
            Le Semi-marathon d&apos;Angers, c&apos;est bien plus qu&apos;une course.
            C&apos;est une expérience sportive inoubliable au cœur d&apos;Angers.
          </p>
        </motion.div>
